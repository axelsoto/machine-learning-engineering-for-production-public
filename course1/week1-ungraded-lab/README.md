...
```bash
git clone https://github.com/axelsoto/machine-learning-engineering-for-production-public.git
```

or for cloning via SSH use:
```bash
git clone git@github.com:axelsoto/machine-learning-engineering-for-production-public.git
```
